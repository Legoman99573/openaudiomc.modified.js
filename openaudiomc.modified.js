...
openaudio.decode = function(msg) {
	...
	if (request.src != null) {
		if (request.src.includes("soundcloud.com")) {
			...
			request.src = "https://craftmend.com/api_SSL/soundcloud/?file=" + scurl;
		}
	}
...
function showqr() {
	swal({
		...
		text: '<center><div id="qrcode"></div><br><a class="btn btn-info" role"button" onclick="showqr2();">Unofficial App QR</a></center>',
		CancelButton: false,
...
function showqr2() {
	swal({
		title: "Qr code for unofficial app",
